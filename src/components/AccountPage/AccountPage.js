        ...
        <div className="container">
          ...
          <div className="col-md-12 col-lg-12">
            <blockquote className="blockquote">
              <h4>{user? (hasValue(user.message) && user.message): ("loading...")}  </h4>
            </blockquote>
          </div>
          ...
          <div className="col-md-12 col-lg-12">
            <blockquote className="blockquote">
              <h4>Current Rating: {user? (user.rating) : (<span>loading</span>) }</h4>
            </blockquote>
          </div>
          ...
          <div className="col-md-12 col-lg-12">
            <blockquote className="blockquote">
              {user? (user.warning > 0 && <h4>Account warnings: user.warning_count</h4>) : (<span>loading</span>)}
            </blockquote>
          </div>


          <h1 className="text-center"><u>Personal Details</u></h1>
          {user? (<PersonalDetails auth={this.props.auth}/>) : (<span>loading Personal Details ...</span>) }


          <h3><u>Current Balance / Deposit Money</u></h3>
          <div className="col-md-12 col-lg-12">
            <blockquote className="blockquote">
              {user? (user.pending ? (<h4>Account must be accepted before depositing money</h4>) : 
                (
